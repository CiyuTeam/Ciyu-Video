...
final hasHighlightProvider =
    StateProvider.family.autoDispose<bool, String>((ref, wordId) => false);

final isMetProvider =
  StateProvider.family<bool, String>((ref, wordId) => false);

final newlyBondedStatusProvider = Provider.family.autoDispose<bool?, String>((ref, wordId) {
...
final isBondedProvider = Provider.family.autoDispose<bool, String>((ref, wordId) {
