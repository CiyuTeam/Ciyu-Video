...
final articlesProvider =
    StateNotifierProvider.family.autoDispose<ArticlesNotifier, List<SearchHitArticle>, String>(
        (ref, source) => ArticlesNotifier(ref, source));
...
class ArticlesNotifier extends StateNotifier<List<SearchHitArticle>> {
  ...
  bool _loading = false;
  final String source;
  ArticlesNotifier(this.ref, this.source) : super([]) {
    fetch();
  }
