import 'package:ciyu/pages/generation_page.dart';
import 'package:ciyu/pages/glossary_page.dart';
import 'package:ciyu/pages/history_page.dart';
    ...
    return Scaffold(
      appBar: AppBar(
        actions: [
          ...
          IconButton(
            onPressed: () => Navigator.of(context).push(HistoryPage.route()),
            icon: Icon(Icons.history),
          ),
          IconButton(
            onPressed: () => Navigator.of(context).push(GenerationPage.route()),
            ...
            Padding(
              ...
              child: AppBar(
                ...
                actions: [
                  IconButton(
                    onPressed: () =>
                        Navigator.of(context).push(GlossaryPage.route()),
                    icon: Icon(Icons.add),
                  )
                ],
                titleSpacing: 20,
