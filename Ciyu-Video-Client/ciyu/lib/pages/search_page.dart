import 'package:ciyu/widgets/article_list_view.dart';
    ...
    return Scaffold(
      ...
      body: Consumer(
        builder: (context, ref, child) {
          ...
          SearchArticlesNotifier searchArticlesNotifier = ref.read(searchArticlesProvider.notifier);
          if (searchArticlesNotifier.wordId != null)
            return ArticleListView(articles: articles,
              onFetch: () => searchArticlesNotifier.fetch(),
              onReset: () => searchArticlesNotifier.reset(),
            );
          else
            return Container();
