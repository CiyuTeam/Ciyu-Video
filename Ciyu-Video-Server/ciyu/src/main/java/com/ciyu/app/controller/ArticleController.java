...
//    }
    ...
    public SearchHits<Article> getBestArticles(@CurrentUser User user, @Parameter(hidden = true) Pageable pageable, @RequestParam List<String> excludedArticleIds, String source) {
        return articleService.searchBestArticlesByUser(user, pageable, excludedArticleIds, source);
    }
